...
def calculate_seasonal_average(months, data):
    seasonal_list = [float(row[1]) for row in data if row[0].split("-")[1] in months]
...
spring_avg = calculate_seasonal_average(['03', '04', '05'], csv_reader)
summer_avg = calculate_seasonal_average(['06', '07', '08'], csv_reader)
autumn_avg = calculate_seasonal_average(['09', '10', '11'], csv_reader)
winter_avg = calculate_seasonal_average(['12', '01', '02'], csv_reader)
